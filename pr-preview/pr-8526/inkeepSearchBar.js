    ...
    inkeepSearchBarScript.addEventListener("load", function () {
      const inkeepConfigSearchBar = {"baseSettings":{"apiKey":"","integrationId":"","organizationId":"","primaryBrandColor":"#1E1E1E"},"aiChatSettings":{"chatSubjectName":"goose","botAvatarSrcUrl":"","getHelpCallToActions":[{"name":"GitHub","url":"https://github.com/aaif-goose/goose","icon":{"builtIn":"FaGithub"}}],"quickQuestions":["What is goose?"]}};
